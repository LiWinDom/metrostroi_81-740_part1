...
-- VityazM Train Equipment - Integrated Traffic System - Modified
--------------------------------------------------------------------------------
-- Коды ошибок:
-- 0x0000 - норма
-- 0x0001 -
...
--------------------------------------------------------------------------------
Metrostroi.DefineSystem("VityazM")
...
function TRAIN_SYSTEM:ClientInitialize()
	...
	local translate = file.Read("metrostroi_data/language/VityazM_en.json")
	if translate then
...
if CLIENT then
	...
	function TRAIN_SYSTEM:VityazM(train)
		...
		self.Types=self.TypesRussian
		self.Questions=self.QuestionsRussian
		--print(train:GetNW2Int("VityazM:State"))
		if train:GetNW2Int("VityazM:State",-1) ~= -1 then
			surface.SetDrawColor(Color(20,20,20))
			surface.DrawRect(0,0,512,425)
		end
		if train:GetNW2Int("VityazM:State",-1) == -2 then
			if not self.BSODTimer then self.BSODTimer = CurTime() end
			surface.SetDrawColor(Color(0,0,172))
			surface.DrawRect(0,0,512,425)

            if  CurTime() - self.BSODTimer > 1/32*1 then draw.SimpleText("A problem has been detected and VityazM has been shut down to prevent damage","Metrostroi_PAMBSOD",5, 25,Color(255,255,255),TEXT_ALIGN_LEFT,TEXT_ALIGN_CENTER) end
		...
		if train:GetNW2Int("VityazM:State",-1) == 0 then
		...
		if train:GetNW2Int("VityazM:State",-1) == 3 then
			self.ErrorCodes = {
			...
			local ErrorCode = train:GetNW2Int("VityazM:ErrorCode",0)
			local BackErrorCode = train:GetNW2Int("VityazM:BErrorCode",0)
			...
			if not train:GetNW2Bool("VityazM:BackPA") or BackErrorCode == 0x9999 then
			...
			if not train:GetNW2Bool("VityazM:BackPA") then
			...
			elseif not train:GetNW2Bool("VityazM:RR",false) then
			...
			if train:GetNW2Bool("VityazM:BackPAErrorNoAccepted") then
				...
				Metrostroi.DrawTextRectOL(166, 210, 180, 40,train:GetNW2Bool("VityazM:NCCanc",false) and Color(42,58,148) or Color(230,230,230),gr_up,2,Color(110,110,110))
				draw.SimpleText(self.T("Подтвердить"),"Metrostroi_PAM30",256, 230,train:GetNW2Bool("VityazM:NCCanc") and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)

				--draw.SimpleText(self.Questions[train:GetNW2Int("VityazM:NeedConfirm",0)].."?","Metrostroi_PAM30",256, 180,Color(0,0,0,255),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
			end

		end
		if train:GetNW2Int("VityazM:State",-1) == 4 then
			surface.SetDrawColor(Color(200,200,200))
			surface.DrawRect(0,0,512,425)
			--elf.Train:GetNW2Int("VityazM:Pass",0) ~= -1 and string.rep("*",self.Train:GetNW2Int("VityazM:Pass",0)) or "ACCESS ERROR"
			Metrostroi.DrawRectOutline(10, 80, 492, 170,Color(20,20,20),3 )
			if train:GetNW2Int("VityazM:Pass",0) == -1 then
				...
				if train:GetNW2Int("VityazM:Pass",0) > 0 then
					surface.SetDrawColor(Color(240,240,240))
					--surface.DrawTexturedRect(241 - train:GetNW2Int("VityazM:Pass",0)*12, 165, 30 + train:GetNW2Int("VityazM:Pass",0)*24, 40)
					Metrostroi.DrawTextRectOL(241 - train:GetNW2Int("VityazM:Pass",0)*12, 165, 30 + train:GetNW2Int("VityazM:Pass",0)*24, 40,Color(200,200,200),gr_up,2,Color(110,110,110))
					--Metrostroi.DrawRectOL(241 - train:GetNW2Int("VityazM:Pass",0)*12, 165, 30 + train:GetNW2Int("VityazM:Pass",0)*24, 40,Color(20,20,20),3,Color(230,230,2300))
					draw.SimpleText(string.rep("*",train:GetNW2Int("VityazM:Pass",0)),"Metrostroi_PAM80",256, 200,Color(0,0,0,255),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				end
			end
		...
		if train:GetNW2Int("VityazM:State",-1) == 5 then
			surface.SetDrawColor(Color(200,200,200))
			surface.DrawRect(0,0,512,425)
			...
			Metrostroi.DrawTextRectOL(40, 140, 432, 40,train:GetNW2Int("VityazM:State5",1) == 1 and Color(42,58,148) or Color(230,230,230),gr_up,3,Color(110,110,110))
			draw.SimpleText("1","Metrostroi_PAM30",60, 160,train:GetNW2Int("VityazM:State5",1) == 1 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_LEFT,TEXT_ALIGN_CENTER)
			Metrostroi.DrawLine(60,173,75,173,train:GetNW2Int("VityazM:State5",1) == 1 and Color(255,255,255) or Color(0,0,0),3)
			draw.SimpleText(self.T("Выход на линию"),"Metrostroi_PAM30",100, 160,train:GetNW2Int("VityazM:State5",1) == 1 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_LEFT,TEXT_ALIGN_CENTER)

			if train:GetNW2Bool("VityazM:Restart") then
				Metrostroi.DrawTextRectOL(40, 190, 432, 40,train:GetNW2Int("VityazM:State5",1) == 2 and Color(42,58,148) or Color(230,230,230),gr_up,3,Color(110,110,110))
				draw.SimpleText("2","Metrostroi_PAM30",60, 210,train:GetNW2Int("VityazM:State5",1) == 2 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_LEFT,TEXT_ALIGN_CENTER)
				Metrostroi.DrawLine(60,222,75,222,train:GetNW2Int("VityazM:State5",1) == 2 and Color(255,255,255) or Color(0,0,0),3)
				draw.SimpleText(self.T("Перезапуск"),"Metrostroi_PAM30",100, 210,train:GetNW2Int("VityazM:State5",1) == 2 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_LEFT,TEXT_ALIGN_CENTER)
			end

			Metrostroi.DrawTextRectOL(40, 240, 432, 40,train:GetNW2Int("VityazM:State5",1) == 3 and Color(42,58,148) or Color(230,230,230),gr_up,3,Color(110,110,110))
			--draw.SimpleText("1","Metrostroi_PAM30",60, 260,train:GetNW2Int("VityazM:State5",1) == 1 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_LEFT,TEXT_ALIGN_CENTER)
			--Metrostroi.DrawLine(60,273,75,273,train:GetNW2Int("VityazM:State5",1) == 1 and Color(255,255,255) or Color(0,0,0),3)
			draw.SimpleText(self.T("Назад"),"Metrostroi_PAM30",100, 260,train:GetNW2Int("VityazM:State5",1) == 3 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_LEFT,TEXT_ALIGN_CENTER)
		end
		if train:GetNW2Int("VityazM:State",-1) == 6 then
			local Line = self.Train:GetNW2Int("VityazM:Line",0)
			local FirstStation = self.Train:GetNW2Int("VityazM:FirstStation",-1)
			local LastStation = self.Train:GetNW2Int("VityazM:LastStation",-1)
			local RouteNumber = self.Train:GetNW2Int("VityazM:RouteNumber",-1)
			...
			Metrostroi.DrawTextRectOL(310, 115, 140, 30,train:GetNW2Int("VityazM:State6",1) == 1 and Color(144,255,237) or Color(230,230,230),gr_up,1,Color(110,110,110))
			...
			Metrostroi.DrawTextRectOL(310, 147, 140, 30,train:GetNW2Int("VityazM:State6",1) == 2 and Color(144,255,237) or Color(230,230,230),gr_up,1,Color(110,110,110))
			...
			Metrostroi.DrawTextRectOL(310, 179, 140, 30,train:GetNW2Int("VityazM:State6",1) == 3 and Color(144,255,237) or Color(230,230,230),gr_up,1,Color(110,110,110))
			...
			Metrostroi.DrawTextRectOL(310, 211, 140, 30,train:GetNW2Int("VityazM:State6",1) == 4 and Color(144,255,237) or Color(230,230,230),gr_up,1,Color(110,110,110))
			...
			if train:GetNW2Int("VityazM:State6",1) == 2 and tbl[Line] then
				local i = 1
			...
			if train:GetNW2Int("VityazM:State6",1) == 3 and tbl[Line] then
				local i = 1
				for k,v in pairs(tbl[Line]) do
			...
			if train:GetNW2Bool("VityazM:State6Error",false) then
		...
		if train:GetNW2Int("VityazM:State",-1) == 7 then
			local Line = self.Train:GetNW2Int("VityazM:Line",0)
			local FirstStation = self.Train:GetNW2Int("VityazM:FirstStation",-1)
			local LastStation = self.Train:GetNW2Int("VityazM:LastStation",-1)
			local RouteNumber = self.Train:GetNW2Int("VityazM:RouteNumber",-1)
		...
		if train:GetNW2Int("VityazM:State",-1) == 8 then
			surface.SetDrawColor(Color(200,200,200))
			surface.DrawRect(0,0,512,425)
		...
		if train:GetNW2Int("VityazM:State",-1) == 9 then
			local Line = train:GetNW2Int("VityazM:Line",0)
			local Path = train:GetNW2Int("VityazM:Path",0)
			local Station = tonumber(train:GetNW2Int("VityazM:Station",0))
			local LastStation = tonumber(train:GetNW2Int("VityazM:LastStation",-1))
			local S = Format("%.2f",train:GetNW2Float("VityazM:Distance",0))
			local speed = math.floor(self.Train:GetPackedRatio(3)*100.0)
			local spd = self.Train:GetNW2Bool("VityazM:UOS", false) and 35 or self.Train:GetNW2Bool("VityazM:VRD",false) and 20 or self.Train:GetPackedBool(46) and 80 or self.Train:GetPackedBool(45) and 70 or self.Train:GetPackedBool(44) and 60 or self.Train:GetPackedBool(43) and 40 or self.Train:GetPackedBool(42) and 0 or "НЧ"
			--Metrostroi.DrawRectOutline(10, 6, 100, 40,Color(110,172,95),3 )
			local date = os.date("!*t",Metrostroi.GetSyncTime())
			...
			--RunConsoleCommand("say",tostring(train:GetPackedBool("VityazM:KS")))
			draw.SimpleText(self.T("1 АВ"),"Metrostroi_PAM30",6, 170,train:GetNW2Bool("VityazM:AV",false) and Color(38,81,109) or Color(200,200,200),TEXT_ALIGN_LEFT,TEXT_ALIGN_CENTER)
			draw.SimpleText(self.T("2 КС"),"Metrostroi_PAM30",6, 200,train:GetNW2Bool("VityazM:KS",false) and Color(38,81,109) or Color(200,200,200),TEXT_ALIGN_LEFT,TEXT_ALIGN_CENTER)
			draw.SimpleText(self.T("3 ОС"),"Metrostroi_PAM30",6, 230,train:GetNW2Bool("VityazM:OD",false) and Color(38,81,109) or Color(200,200,200),TEXT_ALIGN_LEFT,TEXT_ALIGN_CENTER)
			...
			if train:GetNW2Bool("VityazM:Arrived",false) then
				...
				draw.SimpleText(self.T("Тост = ")..math.max(-99,train:GetNW2Int("VityazM:BoardTime",0)),"Metrostroi_PAM28",290, 340,Color(110,172,95),TEXT_ALIGN_LEFT,TEXT_ALIGN_CENTER)
				draw.SimpleText(self.T("S= ")..S..self.T("м"),"Metrostroi_PAM28",506, 340,Color(110,172,95),TEXT_ALIGN_RIGHT,TEXT_ALIGN_CENTER)
			else
				draw.SimpleText(self.T("РЦ= ")..train:GetNW2String("VityazM:SName",""),"Metrostroi_PAM30",6, 340,Color(254,237,142),TEXT_ALIGN_LEFT,TEXT_ALIGN_CENTER)
				draw.SimpleText(Format(self.T("Уклон= %.2f"),train:GetNW2Int("VityazM:Uklon",0)/100),"Metrostroi_PAM30",180, 340,Color(254,237,142),TEXT_ALIGN_LEFT,TEXT_ALIGN_CENTER)
			...
			draw.SimpleText(self.Types[train:GetNW2Int("VityazM:Type",1)].."="..self.Positions[train:GetNW2Int("VityazM:KV",1)],"Metrostroi_PAM30",171, 371,Color(20,20,20),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
			if train:GetNW2Bool("VityazM:VZ1",false) or train:GetNW2Bool("VityazM:VZ2",false) then
				draw.SimpleText(train:GetNW2Bool("VityazM:VZ1",false) and (train:GetNW2Bool("VityazM:VZ2",false) and self.T("В1 2") or self.T("В1")) or self.T("В   2"),"Metrostroi_PAM30",224, 371,Color(20,20,20),TEXT_ALIGN_LEFT,TEXT_ALIGN_CENTER)
			end
			...
			--[[
			surface.SetDrawColor(Color(200,200,200))
			if not train:GetNW2Bool("VityazM:RR",false) then
			...
			draw.SimpleText(self.Types[train:GetNW2Bool("VityazM:Type",false)].."="..self.Positions[train:GetNW2Bool("VityazM:KV",false)],"Metrostroi_PAM30",56, 330,Color(20,20,20),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
			if train:GetNW2Bool("VityazM:VZ1",false) or train:GetNW2Bool("VityazM:VZ2",false) then
				surface.DrawRect(111,320,55,24)
				draw.SimpleText(train:GetNW2Bool("VityazM:VZ1",false) and (train:GetNW2Bool("VityazM:VZ2",false) and "В12" or "В1") or "В2","Metrostroi_PAM30",111 + 55/2, 330,Color(20,20,20),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
			end
			...
			draw.SimpleText(self.T("Тост = ")..train:GetNW2Int("VityazM:BoardTime",0),"Metrostroi_PAM20",375, 365,Color(110,172,95),TEXT_ALIGN_LEFT,TEXT_ALIGN_CENTER)
			]]
			if train:GetNW2Bool("VityazM:Arrived",false) then
				if Station > 0 then
			...
			if train:GetNW2Int("VityazM:Menu",0) > 0 then
				Metrostroi.DrawRectOL(10, 140, 492, 180,Color(110,110,110),1,Color(200,200,200))
				Metrostroi.DrawTextRectOL(10, 140, 164, 45,train:GetNW2Int("VityazM:Menu",1) == 1 and Color(42,58,148) or Color(230,230,230),gr_up,2,Color(110,110,110))
				draw.SimpleText("1","Metrostroi_PAM30",30, 162,train:GetNW2Int("VityazM:Menu",1) == 1 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				draw.SimpleText(self.T("Проверка"),"Metrostroi_PAM22",92, 154,train:GetNW2Int("VityazM:Menu",1) == 1 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				draw.SimpleText(self.T("наката"),"Metrostroi_PAM22",92, 170,train:GetNW2Int("VityazM:Menu",1) == 1 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				Metrostroi.DrawTextRectOL(174, 140, 164, 45,train:GetNW2Int("VityazM:Menu",1) == 2 and Color(42,58,148) or Color(230,230,230),gr_up,2,Color(110,110,110))
				draw.SimpleText("2","Metrostroi_PAM30",194, 162,train:GetNW2Int("VityazM:Menu",1) == 2 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				draw.SimpleText(self.T("Движение"),"Metrostroi_PAM22",256, 154,train:GetNW2Int("VityazM:Menu",1) == 2 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				draw.SimpleText(train:GetNW2Bool("VityazM:KD") and self.T("с КД") or self.T("без КД"),"Metrostroi_PAM22",256, 170,train:GetNW2Int("VityazM:Menu",1) == 2 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				Metrostroi.DrawTextRectOL(338, 140, 164, 45,train:GetNW2Int("VityazM:Menu",1) == 3 and Color(42,58,148) or Color(230,230,230),gr_up,2,Color(110,110,110))
				draw.SimpleText("3","Metrostroi_PAM30",358, 162,train:GetNW2Int("VityazM:Menu",1) == 3 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				draw.SimpleText(self.T("Смена"),"Metrostroi_PAM22",420, 154,train:GetNW2Int("VityazM:Menu",1) == 3 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				draw.SimpleText(self.T("настроек"),"Metrostroi_PAM22",420, 170,train:GetNW2Int("VityazM:Menu",1) == 3 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)

				Metrostroi.DrawTextRectOL(10, 185, 164, 45,train:GetNW2Int("VityazM:Menu",1) == 4 and Color(42,58,148) or Color(230,230,230),gr_up,2,Color(110,110,110))
				draw.SimpleText("4","Metrostroi_PAM30",30, 207,train:GetNW2Int("VityazM:Menu",1) == 4 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				draw.SimpleText(self.T("Движение"),"Metrostroi_PAM22",92, 199,train:GetNW2Int("VityazM:Menu",1) == 4 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				draw.SimpleText(self.T("транзитом"),"Metrostroi_PAM22",92, 215,train:GetNW2Int("VityazM:Menu",1) == 4 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				Metrostroi.DrawTextRectOL(174, 185, 164, 45,train:GetNW2Int("VityazM:Menu",1) == 5 and Color(42,58,148) or Color(230,230,230),gr_up,2,Color(110,110,110))
				draw.SimpleText("5","Metrostroi_PAM30",194, 207,train:GetNW2Int("VityazM:Menu",1) == 5 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				draw.SimpleText(self.T("Движение"),"Metrostroi_PAM22",256, 199,train:GetNW2Int("VityazM:Menu",1) == 5 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				draw.SimpleText(self.T("при Vф=0"),"Metrostroi_PAM22",256, 215,train:GetNW2Int("VityazM:Menu",1) == 5 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				Metrostroi.DrawTextRectOL(338, 185, 164, 45,train:GetNW2Int("VityazM:Menu",1) == 6 and Color(42,58,148) or Color(230,230,230),gr_up,2,Color(110,110,110))
				draw.SimpleText("6","Metrostroi_PAM30",358, 207,train:GetNW2Int("VityazM:Menu",1) == 6 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				draw.SimpleText(self.T("Зонный"),"Metrostroi_PAM22",420, 199,train:GetNW2Int("VityazM:Menu",1) == 6 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				draw.SimpleText(self.T("оборот"),"Metrostroi_PAM22",420, 215,train:GetNW2Int("VityazM:Menu",1) == 6 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)

				Metrostroi.DrawTextRectOL(10, 230, 164, 45,train:GetNW2Int("VityazM:Menu",1) ==7 and Color(42,58,148) or Color(230,230,230),gr_up,2,Color(110,110,110))
				draw.SimpleText("7","Metrostroi_PAM30",30, 252,train:GetNW2Int("VityazM:Menu",1) == 7 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				draw.SimpleText(self.T("Фиксация"),"Metrostroi_PAM22",92, 244,train:GetNW2Int("VityazM:Menu",1) == 7 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				draw.SimpleText(self.T("станции"),"Metrostroi_PAM22",92, 260,train:GetNW2Int("VityazM:Menu",1) == 7 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)

				Metrostroi.DrawTextRectOL(174, 230, 164, 45,train:GetNW2Int("VityazM:Menu",1) ==8 and Color(42,58,148) or Color(230,230,230),gr_up,2,Color(110,110,110))
				draw.SimpleText("8","Metrostroi_PAM30",194, 252,train:GetNW2Int("VityazM:Menu",1) == 8 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				draw.SimpleText(self.T("ИГРУФКИ"),"Metrostroi_PAM22",256, 252,train:GetNW2Int("VityazM:Menu",1) == 8 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				--draw.SimpleText(train:GetNW2Bool("VityazM:KD") and self.T("с КД") or self.T("без КД"),"Metrostroi_PAM22",256, 170,train:GetNW2Int("VityazM:Menu",1) == 1 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
			--[[
				Metrostroi.DrawTextRectOL(338, 230, 164, 45,Color(230,230,230),gr_up,2,Color(110,110,110))
				draw.SimpleText("9","Metrostroi_PAM30",358, 162,train:GetNW2Int("VityazM:Menu",1) == 1 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				draw.SimpleText(self.T("Смена"),"Metrostroi_PAM22",420, 154,train:GetNW2Int("VityazM:Menu",1) == 1 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				draw.SimpleText(self.T("настроек"),"Metrostroi_PAM22",420, 170,train:GetNW2Int("VityazM:Menu",1) == 1 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				...
				Metrostroi.DrawTextRectOL(338, 275, 164, 45,train:GetNW2Int("VityazM:Menu",1) == 12 and Color(42,58,148) or Color(230,230,230),gr_up,2,Color(110,110,110))
				draw.SimpleText(self.T("Закрыть"),"Metrostroi_PAM22",420, 297,train:GetNW2Int("VityazM:Menu",1) == 12 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				--[[
				Metrostroi.DrawRectOutline(50, 150, 385, 24*8,Color(160,160,160), 3)
				surface.SetDrawColor(Color(200,200,200))
				surface.DrawRect(51,151,382,24*8-4)
				surface.SetDrawColor(Color(200,200,200))
				surface.DrawRect(51,127 + train:GetNW2Int("VityazM:Menu",0)*24,382,23)
				...
				draw.SimpleText(train:GetNW2Bool("VityazM:KD") and self.T("Движение с КД") or self.T("Движение без КД"),"Metrostroi_PAM22",256, 186,Color(0,0,0,255),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
			...
			if train:GetNW2Int("VityazM:Ann",0) > 0 then
				Metrostroi.DrawRectOL(10, 140, 492, 180,Color(110,110,110),1,Color(200,200,200))
				Metrostroi.DrawTextRectOL(10, 140, 164, 45,train:GetNW2Int("VityazM:Ann",1) == 1 and Color(42,58,148) or Color(230,230,230),gr_up,2,Color(110,110,110))
				draw.SimpleText("1","Metrostroi_PAM30",30, 162,train:GetNW2Int("VityazM:Ann",1) == 1 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				draw.SimpleText(self.T("Просьба"),"Metrostroi_PAM22",92, 150,train:GetNW2Int("VityazM:Ann",1) == 1 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				draw.SimpleText(self.T("выйти"),"Metrostroi_PAM22",92, 162,train:GetNW2Int("VityazM:Ann",1) == 1 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				draw.SimpleText(self.T("из вагонов"),"Metrostroi_PAM22",92, 174,train:GetNW2Int("VityazM:Ann",1) == 1 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				Metrostroi.DrawTextRectOL(174, 140, 164, 45,train:GetNW2Int("VityazM:Ann",1) == 2 and Color(42,58,148) or Color(230,230,230),gr_up,2,Color(110,110,110))
				draw.SimpleText("2","Metrostroi_PAM30",194, 162,train:GetNW2Int("VityazM:Ann",1) == 2 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				draw.SimpleText(self.T("Заходите"),"Metrostroi_PAM22",266, 150,train:GetNW2Int("VityazM:Ann",1) == 2 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				draw.SimpleText(self.T("и выходите"),"Metrostroi_PAM22",266, 162,train:GetNW2Int("VityazM:Ann",1) == 2 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				draw.SimpleText(self.T("быстрее"),"Metrostroi_PAM22",266, 174,train:GetNW2Int("VityazM:Ann",1) == 2 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				Metrostroi.DrawTextRectOL(338, 140, 164, 45,train:GetNW2Int("VityazM:Ann",1) == 3 and Color(42,58,148) or Color(230,230,230),gr_up,2,Color(110,110,110))
				draw.SimpleText("3","Metrostroi_PAM30",358, 162,train:GetNW2Int("VityazM:Ann",1) == 3 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				draw.SimpleText(self.T("Отпустите"),"Metrostroi_PAM22",440, 150,train:GetNW2Int("VityazM:Ann",1) == 3 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				draw.SimpleText(self.T("пожалуйста"),"Metrostroi_PAM22",440, 162,train:GetNW2Int("VityazM:Ann",1) == 3 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				draw.SimpleText(self.T("двери"),"Metrostroi_PAM22",440, 174,train:GetNW2Int("VityazM:Ann",1) == 3 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)

				Metrostroi.DrawTextRectOL(10, 185, 164, 45,train:GetNW2Int("VityazM:Ann",1) == 4 and Color(42,58,148) or Color(230,230,230),gr_up,2,Color(110,110,110))
				draw.SimpleText("4","Metrostroi_PAM30",30, 207,train:GetNW2Int("VityazM:Ann",1) == 4 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				draw.SimpleText(self.T("Поезд"),"Metrostroi_PAM22",92, 195,train:GetNW2Int("VityazM:Ann",1) == 4 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				draw.SimpleText(self.T("скоро"),"Metrostroi_PAM22",92, 207,train:GetNW2Int("VityazM:Ann",1) == 4 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				draw.SimpleText(self.T("отправится"),"Metrostroi_PAM22",92, 219,train:GetNW2Int("VityazM:Ann",1) == 4 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)

				Metrostroi.DrawTextRectOL(338, 275, 164, 45,train:GetNW2Int("VityazM:Ann",1) == 5 and Color(42,58,148) or Color(230,230,230),gr_up,2,Color(110,110,110))
				draw.SimpleText(self.T("Закрыть"),"Metrostroi_PAM22",420, 297,train:GetNW2Int("VityazM:Ann",1) == 5 and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
			end
			if train:GetNW2Int("VityazM:NeedConfirm",0) > 0 then
				...
				--surface.SetDrawColor(Color(200,200,200))
				--surface.DrawRect(108, 127, 295, 146 )
				if type(self.Questions[train:GetNW2Int("VityazM:NeedConfirm",0)]) == "table" then
					draw.SimpleText(self.Questions[train:GetNW2Int("VityazM:NeedConfirm",0)][1],"Metrostroi_PAM22",256, 182,Color(0,0,0,255),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
					draw.SimpleText(self.Questions[train:GetNW2Int("VityazM:NeedConfirm",0)][2],"Metrostroi_PAM22",256, 198,Color(0,0,0,255),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				else
					draw.SimpleText(self.Questions[train:GetNW2Int("VityazM:NeedConfirm",0)],"Metrostroi_PAM22",256, 190,Color(0,0,0,255),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				end
				--draw.SimpleText(self.T("вводе данных"),"Metrostroi_PAM30",256, 190,Color(0,0,0,255),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				--Metrostroi.DrawRectOutline(190, 220, 132, 40,Color(20,20,20),3 )
				--draw.SimpleText(self.T("ENTER"),"Metrostroi_PAM30",256, 240,Color(0,0,0,255),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				Metrostroi.DrawTextRectOL(111, 210, 140, 40,train:GetNW2Bool("VityazM:NCOk",false) and Color(42,58,148) or Color(230,230,230),gr_up,2,Color(110,110,110))
				draw.SimpleText(self.T("Да - Enter"),"Metrostroi_PAM30",181, 230,train:GetNW2Bool("VityazM:NCOk",false) and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				Metrostroi.DrawTextRectOL(261, 210, 140, 40,train:GetNW2Bool("VityazM:NCCanc",false) and Color(42,58,148) or Color(230,230,230),gr_up,2,Color(110,110,110))
				draw.SimpleText(self.T("Нет - Esc"),"Metrostroi_PAM30",331, 230,train:GetNW2Bool("VityazM:NCCanc") and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)

				--draw.SimpleText(self.Questions[train:GetNW2Int("VityazM:NeedConfirm",0)].."?","Metrostroi_PAM30",256, 180,Color(0,0,0,255),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
			end
			if train:GetNW2Bool("VityazM:Nakat") then
				Metrostroi.DrawTextRectOL(106, 155, 300, 30,Color(42,58,148),gr_up,1,Color(110,110,110))
				...
				draw.SimpleText(Format("%.2f",self.Train:GetNW2Float("VityazM:Meters",0)),"Metrostroi_PAM30",300, 195,Color(254,237,142),TEXT_ALIGN_LEFT,TEXT_ALIGN_CENTER)
				draw.SimpleText(self.T("Направление: "),"Metrostroi_PAM30",111, 225,Color(2,2,2),TEXT_ALIGN_LEFT,TEXT_ALIGN_CENTER)
				draw.SimpleText(self.Train:GetNW2Bool("VityazM:Sign",false) and self.T("Назад") or self.T("Вперёд"),"Metrostroi_PAM30",300, 225,self.Train:GetNW2Bool("VityazM:Sign",false) and Color(200,0,0) or Color(110,172,95),TEXT_ALIGN_LEFT,TEXT_ALIGN_CENTER)
				Metrostroi.DrawTextRectOL(190-20, 240, 132+40, 30,train:GetNW2Bool("VityazM:NCCanc",false) and Color(42,58,148) or Color(230,230,230),gr_up,2,Color(110,110,110))
				draw.SimpleText(self.T("Отмена - Esc"),"Metrostroi_PAM30",256, 255,train:GetNW2Bool("VityazM:NCCanc",false) and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
			end
			if train:GetNW2Bool("VityazM:SetupError",false) then
				Metrostroi.DrawTextRectOL(106, 125, 300, 30,Color(42,58,148),gr_up,1,Color(110,110,110))
				Metrostroi.DrawRectOL(106, 145, 300, 136,Color(110,110,110),1,Color(200,200,200))
			...
			if train:GetNW2Int("VityazM:Fix",-1) > -1 or train:GetNW2Int("VityazM:Zon",-1) > -1 then
				local Line = train:GetNW2Int("VityazM:FLine",0)
				local Station = train:GetNW2Int("VityazM:FStation",0)
				local choosed = train:GetNW2Int("VityazM:Fix",-1) > -1 and train:GetNW2Int("VityazM:Fix",0) or train:GetNW2Int("VityazM:Zon",0)
				...
				draw.SimpleText(train:GetNW2Int("VityazM:Fix",-1) > -1 and self.T("Фиксация станции") or self.T("Зонный оборот"),"Metrostroi_PAM25",256, 153,Color(255,255,255),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				...
				Metrostroi.DrawTextRectOL(100, 286, 100, 30,train:GetNW2Bool("VityazM:NCOk",false) and Color(42,58,148) or Color(230,230,230),gr_up,2,Color(110,110,110))
				draw.SimpleText(self.T("Ввод"),"Metrostroi_PAM30",150, 300,train:GetNW2Bool("VityazM:NCOk",false) and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
				Metrostroi.DrawTextRectOL(294, 286, 115, 30,train:GetNW2Bool("VityazM:NCCanc",false) and Color(42,58,148) or Color(230,230,230),gr_up,2,Color(110,110,110))
				draw.SimpleText(self.T("Закрыть"),"Metrostroi_PAM30",349, 300,train:GetNW2Bool("VityazM:NCCanc",false) and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
		...
		if train:GetNW2Bool("VityazM:2048") then
			...
			draw.SimpleText(self.T("2048 Счёт:")..train:GetNW2Int("VityazM:2048Score",0),"Metrostroi_PAM25",166, 113,Color(255,255,255),TEXT_ALIGN_LEFT,TEXT_ALIGN_CENTER)
			self.g2048col = {
				Color(238,228,218),
				Color(236,224,200),
				Color(242,177,121),
			...
			for i = 0,15 do
				local val = train:GetNW2Int("VityazM:2048:"..math.floor(i/4+1)..":"..(i%4+1),0)
				if val ~= 0 then
			...
			Metrostroi.DrawTextRectOL(156, 330, 200, 40,train:GetNW2Bool("VityazM:NCCanc") and Color(42,58,148) or Color(230,230,230),gr_up,2,Color(110,110,110))
			draw.SimpleText(self.T("Выход - Esc"),"Metrostroi_PAM30",256, 350,train:GetNW2Bool("VityazM:NCCanc") and Color(255,255,255) or Color(0,0,0),TEXT_ALIGN_CENTER,TEXT_ALIGN_CENTER)
		end
...
function TRAIN_SYSTEM:Touch(state,x,y)
	...
	if self.State == 5 and self.Train:GetNW2Bool("VityazM:Restart") and self:FindAimButton(x,y,40, 190, 432, 40) then
		if state then
			self.State5Choose = 2
		else
			self:SetState(1.1,7)
	...
	if self.State == 9 then
		if self.Train:GetNW2Bool("VityazM:SetupError",false) then
			if self:FindAimButton(x,y,216, 220, 80, 40) then
				for k,v in pairs(self.Train.WagonList) do
					v["VityazM"]:SetState(3)
				end
			end
			return
		end
...
function TRAIN_SYSTEM:Trigger(name,nosnd)
	...
	elseif self.State == 5 then
		if name == "BDown" then
			...
			if self.State5Choose == 2 and not self.Train:GetNW2Bool("VityazM:Restart") then self.State5Choose = self.State5Choose + 1 end
		end
		if name == "BUp" then
		...
		if name == "B2" and self.Train:GetNW2Bool("VityazM:Restart") then
			self:SetState(1.1,7)
		end
	...
	elseif self.State == 7 then
		...
		if name == "BEnter" and self.State6Choose == 4 then
			if not Metrostroi.WorkingStations[self.Line] or
				...
				self:SetState(1.1,9)
				for k,v in pairs(self.Train.WagonList) do
					if v ~= self.Train and v["VityazM"] then
						v["VityazM"]:SetState(9)
					end
...
function TRAIN_SYSTEM:SetState(state,add,state9)
	...
	if state == 8 then
		...
		if not state9 then
			for k,v in pairs(self.Train.WagonList) do
				if v ~= self.Train and v["VityazM"] then
					v["VityazM"]:SetState(8,nil,true)
					--v["VityazM"].Line = self.Line
					--v["VityazM"].RouteNumber = self.RouteNumber
					--v["VityazM"].FirstStation = self.FirstStation
					--v["VityazM"].LastStation = self.LastStation
					--v:OnButtonPress("RouteNumberUpdate",self.RouteNumber)
				end
				--if v.UPO then v.UPO:SetStations(self.Line,self.FirstStation,self.LastStation,false) end
			end
...
function TRAIN_SYSTEM:Think(dT)
	...
	if self.Train.VPA.Value > 1 then --not self.VPA and
		for k,v in pairs(self.Train.WagonList) do
			if v["VityazM"] then v["VityazM"].VPA = true end
		end
	end
	...
	if self.OffTimer and (CurTime() - self.OffTimer) > 0 then
		for k,v in pairs(self.Train.WagonList) do
			if v["VityazM"] then v["VityazM"].VPA = false end
		end
		self.OffTimer = nil
	end
	...
	if (CurTime() - self.Time) > 0.1 or self.TimeOverride then
		...
		--print(1)
		self.Time = CurTime()
		Train:SetNW2Int("VityazM:State",self.State)
		if self.State == 3 then
			Train:SetNW2Bool("VityazM:BackPAErrorNoAccepted",self.BackPAEA == true)
			Train:SetNW2Bool("VityazM:BackPA",self.BackPA ~= nil)
			Train:SetNW2Bool("VityazM:RR",self.Train.KV.ReverserPosition ~= 0)
			Train:SetNW2Int("VityazM:ErrorCode",self.ErrorCode or 0x0000)
			Train:SetNW2Int("VityazM:BErrorCode",self.BackErrorCode or 0x0000)
		elseif self.State == 4 then
			Train:SetNW2Int("VityazM:Pass",self.EnteredPass ~= "/" and #self.EnteredPass or -1)
		elseif self.State == 5 then
			Train:SetNW2Bool("VityazM:Restart",self.FirstStation ~= "" and self.LastStation ~= "")
			Train:SetNW2Int("VityazM:State5",self.State5Choose)
		elseif self.State == 6 then
			Train:SetNW2Int("VityazM:State6",self.State6Choose)
			Train:SetNW2Bool("VityazM:State6Error",self.State6Error)
			Train:SetNW2Int("VityazM:LastStation",tonumber(self.LastStation) or -1)
			Train:SetNW2Int("VityazM:FirstStation",tonumber(self.FirstStation) or -1)
			Train:SetNW2Int("VityazM:Line",self.Line)
			Train:SetNW2Int("VityazM:RouteNumber",tonumber(self.RouteNumber ~= "" and self.RouteNumber or -1))
		elseif self.State == 7 then
			Train:SetNW2Int("VityazM:State6",self.State6Choose)
			Train:SetNW2Bool("VityazM:State6Error",self.State6Error)
			Train:SetNW2Int("VityazM:LastStation",tonumber(self.LastStation) or -1)
			...
			--Train:SetNW2Int("VityazM:RouteNumber",tonumber(self.RouteNumber ~= "" and self.RouteNumber or -1))
		elseif self.State == 9 then
			Train:SetNW2Bool("VityazM:AV", self.AutodriveWorking)
			--print(not self.AutodriveWorking and not self.UOS)
			Train:SetNW2Bool("VityazM:KS", not self.AutodriveWorking and not self.UOS)
			Train:SetNW2Bool("VityazM:OD",self.UOS)
			Train:SetNW2Int("VityazM:Line",self.Line)
			Train:SetNW2Int("VityazM:Path",self.Train.UPO.Path)
			Train:SetNW2Int("VityazM:Station",self.State9 == 0 and 0 or self.Train.UPO.Station)
			Train:SetNW2Int("VityazM:LastStation",self.LastStation)
			Train:SetNW2Float("VityazM:Distance",math.Round(self.Train.UPO.Distance,2))
			Train:SetNW2String("VityazM:SName",ARS.Signal and ARS.Signal.RealName or "ERR")
			Train:SetNW2Bool("VityazM:RR",self.Train.KV.ReverserPosition ~= 0)
			Train:SetNW2Int("VityazM:Type",(self.Train.Pneumatic.EmergencyValveEPK and 0 or self.Train.ALS_ARS.UAVAContacts and 4 or self.UOS and 5 or self.VRD and 2 or (self.Train.Autodrive.AutodriveEnabled or self.Train.UPO.StationAutodrive) and 1 or 3))
			Train:SetNW2Int("VityazM:KV",self.Train.Autodrive.AutodriveEnabled and (self.Rotating and -3 or self.Brake and -1 or self.Accelerate and 3 or 0) or (ARS["33G"] > 0 or (self.UOS and (ARS["8"] + (1-self.Train.RPB.Value)) > 0)) and 5 or self.Train.KV.RealControllerPosition)
			Train:SetNW2Bool("VityazM:VZ1", self.Train:ReadTrainWire(29) > 0)
			Train:SetNW2Bool("VityazM:VZ2", self.Train.PneumaticNo2.Value > 0)
			Train:SetNW2Int("VityazM:Menu", self.MenuChoosed)
			Train:SetNW2Int("VityazM:Ann",self.AnnChoosed)
			Train:SetNW2Int("VityazM:NeedConfirm",self.NeedConfirm)
			if self.NeedConfirm > 0 then
				Train:SetNW2Bool("VityazM:NCOk",self.NCOk)
				Train:SetNW2Bool("VityazM:NCCanc",self.NCCanc)
			end
			Train:SetNW2Bool("VityazM:Arrived", Train.UPO.Arrived ~= nil and Train.UPO.BoardTime ~= nil)
			if Train.UPO.Arrived ~= nil and Train.UPO.BoardTime ~= nil then
				Train:SetNW2Int("VityazM:BoardTime",math.floor((Train.UPO.BoardTime or CurTime()) - CurTime()))
			end
			Train:SetNW2Bool("VityazM:SetupError",Metrostroi.AnnouncerData[tonumber(self.FirstStation)] == nil or Metrostroi.AnnouncerData[tonumber(self.LastStation)] == nil)
			Train:SetNW2Bool("VityazM:KD",self.KD)
			Train:SetNW2Bool("VityazM:LPT",self.LPT)
			Train:SetNW2Bool("VityazM:Nakat",self.Nakat)
			Train:SetNW2Int("VityazM:Uklon",math.floor(Train:GetAngles().pitch*100))
			if self.Nakat then
				Train:SetNW2Float("VityazM:Meters",math.Round(math.abs(self.Meters or 0),2))
				Train:SetNW2Bool("VityazM:Sign",ARS.Speed > 0.5 and self.Train.SpeedSign < 0)
				Train:SetNW2Bool("VityazM:NCCanc",self.NCCanc)
			end
			Train:SetNW2Bool("VityazM:2048",self.g2048 ~= nil)
			if self.g2048 then
				Train:SetNW2Int("VityazM:2048Score",self.g2048s)
				Train:SetNW2Bool("VityazM:2048GG",self.g2048go)
				for i = 0,4*4-1 do
					Train:SetNW2Int("VityazM:2048:"..math.floor(i/4+1)..":"..(i%4+1),self.g2048[i] or 0)
				end
				Train:SetNW2Bool("VityazM:NCCanc",self.NCCanc)
			end
			self.Train:SetNW2Int("VityazM:Fix",self.Fix or -1)
			self.Train:SetNW2Int("VityazM:Zon",self.Zon or -1)
			if self.Fix or self.Zon then
				Train:SetNW2Bool("VityazM:NCOk",self.NCOk)
				Train:SetNW2Bool("VityazM:NCCanc",self.NCCanc)
				Train:SetNW2Int("VityazM:FLine",self.FLine or -1)
				Train:SetNW2Int("VityazM:FStation",tonumber(self.EnteredStation) or -1)
				--Train:SetNW2Int("VityazM:FAc",tonumber(self.FStation) or -1)
				Train:SetNW2Bool("VityazM:State6Error",self.State6Error)
			end
